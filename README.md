...
date +"%F"\ "%T" > "${OUTPUT_DIR}"/buildInfo.md

#echo $(pwd) >> buildInfo.md
cd "${OUTPUT_DIR}"
echo "${CURRENT_PROJECT_VERSION}" >> buildInfo.md
echo "$(lipo -info ORBApiKit.framework/ORBApiKit)" >> buildInfo.md
